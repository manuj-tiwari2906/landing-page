      ...
      >
        <SwiperSlide>
          <div className="swipe-card">
            ...
            <div style={{ textAlign: 'left' }}>Career defining courses. Practical Approach. Global Certifications</div>
            <div style={{ color: '#fca61f', fontWeight: 600, width: '100%', textAlign: 'left' }}>{'View Programs ->'}</div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
        <div className="swipe-card">
